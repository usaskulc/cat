...
@SuppressWarnings("unchecked")
HashMap<String, ArrayList<Double>>  organizedTeachingMethodData = (HashMap<String, ArrayList<Double>>)session.getAttribute("organizedTeachingMethodData");
List<CourseTeachingMethodOption> teachingMethodData = pm.getProgramCourseTeachingMethodOptions(o);
Map<String, Integer> offeringCounts = pm.getCourseOfferingCounts( o );
organizedTeachingMethodData = pm.organizeTeachingMethodData(teachingMethodData, maxValue, offeringCounts);
if(debug)
{
